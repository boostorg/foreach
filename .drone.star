...
def main(ctx):
  ...
  linux_cxx("TOOLSET=clang CXXSTD=03,11,14,1z Job 1", "clang++", packages="", buildtype="boost", buildscript="drone", image=linuxglobalimage, environment={'TOOLSET': 'clang', 'CXXSTD': '03,11,14,1z', 'DRONE_JOB_UUID': '356a192b79'}, globalenv=globalenv),
